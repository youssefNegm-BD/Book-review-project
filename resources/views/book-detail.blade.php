        ...
        <div class="row justify-content-center d-flex mt-5">
            <div class="col-md-12">
                ...
                <div class="row mt-4">
                    <div class="col-md-4">
                    @if ($book->image != '')
                                <img src="{{asset('uploads/book/thumb/'.$book->image)}}" width="400" height="450" alt="" class="card-img-top">
                                @else
                    ...
                    @include('layouts.message')
                        ...
                        <div class="star-rating d-inline-flex ml-2" title="">
                            <span class="rating-text theme-font theme-yellow">{{number_format($avgRate,1)}}</span>
                            ...
                            <div class="col-md-12">
                                ...
                                @if($relatedBooks->isNotEmpty())
                                    ...
                                    <a href="{{route('book.detail',$relatedBook->id)}}">
                                        ...
                                        <img src="{{asset('uploads/book/thumb/'.$relatedBook->image)}}"  width="250" 
                                        height="300" alt="" class="card-img-top">
                                        @else
                                        <img src="https://placehold.co/990x1400?text=No Image" alt="" class="card-img-top">
                                        @endif
                                    </a>
                                    ...
                                    if($relatedBook->reviews_count > 0){
                                        $avgRate = $relatedBook->reviews_sum_rating / $relatedBook->reviews_count;
                                    }else{
                                        $avgRate = 0;
                                    }
                                    $avgPer = ($avgRate*100)/5;
    ...
    <div class="modal fade " id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{route('book.saveReview',$book->id)}}" method="Post" id="bookReview" name="bookReview">
                    @csrf 
