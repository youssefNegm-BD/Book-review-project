                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-11 col-md-11">
                                    <input type="text" value="{{Request::get('search')}}" class="form-control form-control-lg" name="search" placeholder="Search by title">
                                </div>
                    ...
                    <div class="col-md-4 col-lg-3 mb-4">
                        <div class="card border-0 shadow-lg">
                            ...
                            <a href="{{route('book.detail',$book->id)}}">
                                @if ($book->image != '')
                                <img src="{{asset('uploads/book/thumb/'.$book->image)}}"  width="200" height="250" alt="" class="card-img-top">
                                @else
